...
**Outputs**:
- `software/elemrv_h/pwm_test/pwm_test.bin`
- `software/elemrv_h/pwm_test/pwm_test.elf`
- `software/elemrv_h/pwm_test/pwm_regtest.bin`
- Other test firmware
...
**Output**: `renode/verilated/libs/libpwm.so`
...
- `gen/WishboneUart.v`
- `gen/WishboneMachineTimer.v`
- `gen/WishbonePio.v`
- `gen/WishbonePinmux.v`  
...
cd renode/verilated/wrappers && bash build_all_cosim.sh release

# Debug build (verbose logging)
cd renode/verilated/wrappers && bash build_all_cosim.sh debug
```
...
**Location**: `renode/verilated/testbenches/`  
...
**Loads**: `renode/gdb/elemrv.gdb` (convenience commands)
