...
The `renode/gdb/zephyr_threads.py` script reads Zephyr's kernel data structures directly from memory using GDB's Python API.
...
task dt-debug-connect ELF=software/elemrv-zephyr/build-debug/zephyr/zephyr.elf
