...
module WishboneSpiController (
  ...
  wire       [1:0]    spiControllerCtrl_1_io_spi_dq_write;
  wire       [1:0]    spiControllerCtrl_1_io_spi_dq_writeEnable;
  ...
  SpiControllerCtrl spiControllerCtrl_1 (
    ...
    .io_spi_dq_write         (spiControllerCtrl_1_io_spi_dq_write[1:0]      ), //o
    .io_spi_dq_writeEnable   (spiControllerCtrl_1_io_spi_dq_writeEnable[1:0]), //o
  ...
  always @(*) begin
    ...
    case(busFactory_byteAddress)
      ...
      12'h008 : begin
        io_bus_DAT_MISO[31 : 0] = {{8'h0,16'h0001},8'h02};
      end
      12'h00c : begin
  ...
  always @(posedge clk or negedge resetn) begin
    if(!resetn) begin
      _zz_io_bus_ACK <= 1'b0;
      _zz_io_bus_DAT_MISO <= 16'h0;
      _zz_io_bus_DAT_MISO_2 <= 16'h0;
      _zz_io_bus_DAT_MISO_3 <= 16'h0;
      _zz_io_bus_DAT_MISO_4 <= 16'h0;
