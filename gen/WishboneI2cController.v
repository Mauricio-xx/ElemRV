...
module WishboneI2cController (
  ...
  InterruptCtrl mapper_interruptCtrl_irqCtrl (
    ...
    .io_masks    (io_masks_driver[2:0]                         ), //i
  ...
  always @(*) begin
    ...
    case(_zz_3)
      ...
      12'h018 : begin
        io_bus_DAT_MISO[20 : 16] = mapper_cmdLogic_fifoVacancy;
      ...
      12'h024 : begin
        io_bus_DAT_MISO[4 : 0] = mapper_interruptCtrl_cmdOccupancyTrigger;
      end
      12'h028 : begin
        io_bus_DAT_MISO[2 : 0] = mapper_interruptCtrl_irqCtrl_io_pendings;
      end
      12'h02c : begin
        io_bus_DAT_MISO[2 : 0] = io_masks_driver;
      end
      default : begin
      end
    endcase
  ...
  always @(*) begin
    ...
    case(_zz_3)
      12'h028 : begin
        if(_zz_1) begin
          mapper_interruptCtrl_irqCtrl_io_clears = io_bus_DAT_MOSI[2 : 0];
        end
      end
      default : begin
      end
  ...
  always @(posedge clk or negedge resetn) begin
    if(!resetn) begin
      _zz_io_bus_ACK <= 1'b0;
      io_masks_driver <= 3'b000;
    end else begin
      _zz_io_bus_ACK <= (io_bus_STB && io_bus_CYC);
      case(_zz_3)
        12'h02c : begin
          if(_zz_1) begin
            io_masks_driver <= io_bus_DAT_MOSI[2 : 0];
          end
        end
        default : begin
        end
  ...
  always @(posedge clk) begin
    ...
    case(_zz_3)
      ...
      12'h024 : begin
        if(_zz_1) begin
          mapper_interruptCtrl_cmdOccupancyTrigger <= io_bus_DAT_MOSI[4 : 0];
        end
      end
      default : begin
      end
