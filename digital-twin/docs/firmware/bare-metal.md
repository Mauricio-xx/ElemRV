...
```bash
cd digital-twin/firmware/pwm_test
...
```c
// pwm.h (simplified from actual digital-twin/firmware/pwm_test/pwm.h)
#ifndef PWM_H
#define PWM_H
...
```makefile
# Makefile (from actual digital-twin/firmware/pwm_test/Makefile)
...
> **Note**: This UART example is conceptual. No `uart_test.c` exists in the repository. Consult `digital-twin/gen/WishboneUart.v` for the actual register layout.
...
# Load firmware
sysbus LoadBinary @digital-twin/firmware/pwm_test/pwm_test.bin 0xA0000000
cpu PC 0xA0000000
