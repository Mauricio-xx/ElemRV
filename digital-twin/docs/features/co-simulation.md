...
```bash
# Check path
ls -la digital-twin/renode/verilated/libs/

# Verify architecture
file digital-twin/renode/verilated/libs/libpwm.so
...
```bash
cd digital-twin/renode/verilated/testbenches
