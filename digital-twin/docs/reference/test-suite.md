...
Tests are numbered sequentially in `digital-twin/renode/run_tests.sh`. The ordering reflects the actual script:
...
**Firmware**: `digital-twin/renode/firmware/samples/spi_quad_flash_test/`
...
**Firmware**: `digital-twin/zephyr/elemrv-zephyr/app/spi_quad_flash/`
...
**Firmware**: `digital-twin/renode/firmware/samples/xip_exec_test/`
...
**Firmware**: `digital-twin/renode/firmware/samples/xip_bootrom_test/`
...
**Firmware**: `digital-twin/renode/firmware/samples/xip_cjal_repro/`
...
**Firmware**: `digital-twin/renode/firmware/samples/xip_cache_invalidate/`
