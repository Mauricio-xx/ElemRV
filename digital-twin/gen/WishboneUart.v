...
module WishboneUart (
  ...
  wire       [6:0]    io_read_queueWithOccupancy_io_occupancy;
  wire       [6:0]    io_read_queueWithOccupancy_io_availability;
  ...
  reg        [6:0]    _zz_io_bus_DAT_MISO;
  reg        [6:0]    io_occupancy_regNext;
  ...
  assign _zz_io_inputs = (_zz_io_bus_DAT_MISO + 7'h01);
  UartCtrl ctrl (
  ...
  StreamFifo io_read_queueWithOccupancy (
    ...
    .io_flush        (1'b0                                           ), //i
    .io_occupancy    (io_read_queueWithOccupancy_io_occupancy[6:0]   ), //o
    .io_availability (io_read_queueWithOccupancy_io_availability[6:0]), //o
    .clk             (clk                                            ), //i
    .resetn          (resetn                                         )  //i
  );
  ...
  always @(*) begin
    ...
    case(_zz_3)
      ...
      12'h010 : begin
        io_bus_DAT_MISO[31 : 0] = {{16'h0,8'h40},8'h40};
      end
      12'h014 : begin
      ...
      12'h01c : begin
        io_bus_DAT_MISO[22 : 16] = mapper_tx_fifoVacancy;
        io_bus_DAT_MISO[30 : 24] = io_read_queueWithOccupancy_io_occupancy;
      end
      12'h020 : begin
      ...
      12'h028 : begin
        io_bus_DAT_MISO[6 : 0] = _zz_io_bus_DAT_MISO;
      end
      12'h02c : begin
  ...
  assign ctrl_io_readIsFull = (7'h3f <= io_read_queueWithOccupancy_io_occupancy);
  always @(*) begin
  ...
  always @(posedge clk or negedge resetn) begin
    if(!resetn) begin
      _zz_io_bus_ACK <= 1'b0;
      mapper_config_cfg_clockDivider <= 20'h00035;
  ...
  always @(posedge clk) begin
    ...
    case(_zz_3)
      ...
      12'h028 : begin
        if(_zz_1) begin
          _zz_io_bus_DAT_MISO <= io_bus_DAT_MOSI[6 : 0];
        end
      end
      default : begin
      end
