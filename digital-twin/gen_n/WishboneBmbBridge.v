...
module SimpleBmbRam (
  ...
  wire                _zz_readData;
  wire       [31:0]   readData;
  wire                when_WishboneBmbBridgeVerilog_l105;
  ...
  always @(*) begin
    _zz_1 = 1'b0;
    if(when_WishboneBmbBridgeVerilog_l105) begin
      _zz_1 = 1'b1;
    end
  end
  ...
  assign when_WishboneBmbBridgeVerilog_l105 = (io_bmb_cmd_valid && (io_bmb_cmd_payload_fragment_opcode == 1'b1));
