...
# Runs inside the Docker container at /workspace/elemrv/digital-twin/renode/
# Callers (Taskfile, CI) invoke via: docker exec <container> bash -c 'cd /workspace/elemrv/digital-twin/renode && bash run_tests.sh'
...
if [ -f "$SCRIPT_DIR/../zephyr/elemrv-zephyr/build-blinky/zephyr/zephyr.elf" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libpio.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libpio.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libpinmux.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libpinmux.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libmtimer.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libmtimer.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libi2c.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libi2c.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libuart.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libuart.so" ]; then
...
if { [ -f "$SCRIPT_DIR/../renode/verilated/libs/libpwm.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libpwm.so" ]; } && \
   ...
   { [ -f "$SCRIPT_DIR/../renode/verilated/libs/libpio.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libpio.so" ]; }; then
    HYBRID_LIBS_OK=true
fi
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libgpio_n.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libgpio_n.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libspi.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libspi.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libspi_quad.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libspi_quad.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libi2c_lite.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libi2c_lite.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libuart_lite.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libuart_lite.so" ]; then
...
if [ -f "$SCRIPT_DIR/../renode/verilated/libs/libpinmux_n.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libpinmux_n.so" ]; then
...
if [ -f "$SCRIPT_DIR/../zephyr/elemrv-zephyr/build-n-hello/zephyr/zephyr.elf" ]; then
...
if { [ -f "$SCRIPT_DIR/../renode/verilated/libs/libspi.so" ] || [ -f "/workspace/elemrv/digital-twin/renode/verilated/libs/libspi.so" ]; } && \
   [ -f "$SCRIPT_DIR/../zephyr/elemrv-zephyr/build-n-sensor-spi-capture/zephyr/zephyr.elf" ]; then
...
if [ -f "$SCRIPT_DIR/../zephyr/elemrv-zephyr/build-portable-data-logger/zephyr/zephyr.elf" ]; then
